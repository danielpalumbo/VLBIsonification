...
im0 = eh.image.load_image('ma+0.5_r80_230_n0_tavg.fits')
imall = eh.image.load_image('ma+0.5_r80_230_nall_tavg.fits')
dummy_obs = eh.obsdata.load_uvfits('dummy_BHEX_M87obs.uvfits')
dummy_obs.ra = im0.ra
dummy_obs.dec = im0.dec
im0.rf = dummy_obs.rf
imall.rf = dummy_obs.rf
obs0 = im0.observe_same(dummy_obs,add_th_noise=False,ampcal=True,phasecal=True)
obsall = imall.observe_same(dummy_obs,add_th_noise=False,ampcal=True,phasecal=True)

sonify(obs0, 'secret_obs_3',dt=1)
sonify(obsall, 'secret_obs_2',dt=1)